    ...
    return (
        <DrawerContentScrollView>
            <AccordionItem title="Structure" icon={faListCheck}>
                <TouchableOpacity style={{ flexDirection: 'row', marginLeft: 30, alignItems: 'center' }} onPress={() => navigation.navigate('Add routine')}>
                ...
                <TouchableOpacity style={{ flexDirection: 'row', marginLeft: 30, alignItems: 'center' }} onPress={() => navigation.navigate('Add task')}>
                    <FontAwesomeIcon icon={faCircle} size={13} style={{ marginRight: 10 }}></FontAwesomeIcon>
                    <Text style={{ fontSize: 18 }}>Add a new task </Text>
                </TouchableOpacity>
                <View style={{ borderWidth: 1, marginHorizontal: 15, marginVertical: 10, borderColor: 'grey' }}></View>
                <TouchableOpacity style={{ flexDirection: 'row', marginLeft: 30, alignItems: 'center' }} onPress={() => navigation.navigate('Calendar')}>
                    <FontAwesomeIcon icon={faCircle} size={13} style={{ marginRight: 10 }}></FontAwesomeIcon>
                    <Text style={{ fontSize: 18 }}>Calendar overview </Text>
                </TouchableOpacity>
                <View style={{ borderWidth: 1, marginHorizontal: 15, marginVertical: 10, borderColor: 'grey' }}></View>
                <TouchableOpacity style={{ flexDirection: 'row', marginLeft: 30, alignItems: 'center' }} onPress={() => navigation.navigate('Daily overview')}>
                    <FontAwesomeIcon icon={faCircle} size={13} style={{ marginRight: 10 }}></FontAwesomeIcon>
                    <Text style={{ fontSize: 18 }}>Daily overview </Text>
                </TouchableOpacity>
            </AccordionItem>
            <AccordionItem title="Forums" icon={faComments}>
                <TouchableOpacity style={{ flexDirection: 'row', marginLeft: 30, alignItems: 'center' }} onPress={() => navigation.navigate('Pick subject')}>
                    <FontAwesomeIcon icon={faCircle} size={13} style={{ marginRight: 10 }}></FontAwesomeIcon>
                    <Text style={{ fontSize: 18 }}>Pick a subject </Text>
                </TouchableOpacity>
                <View style={{ borderWidth: 1, marginHorizontal: 15, marginVertical: 10, borderColor: 'grey' }} ></View>
                <TouchableOpacity style={{ flexDirection: 'row', marginLeft: 30, alignItems: 'center' }} onPress={() => navigation.navigate('Favorite posts')}>
                    <FontAwesomeIcon icon={faCircle} size={13} style={{ marginRight: 10 }}></FontAwesomeIcon>
                    <Text style={{ fontSize: 18 }}>Favorite posts </Text>
                </TouchableOpacity>
            </AccordionItem>
            <AccordionItem title="Learning modules" icon={faGraduationCap}>
                <TouchableOpacity style={{ flexDirection: 'row', marginLeft: 30, alignItems: 'center' }} onPress={() => navigation.navigate('Pick module')}>
                    <FontAwesomeIcon icon={faCircle} size={13} style={{ marginRight: 10 }}></FontAwesomeIcon>
                    <View>
            ...
            <AccordionItem title="Knowledge base" icon={faBrain}>
                <TouchableOpacity style={{ flexDirection: 'row', marginLeft: 30, alignItems: 'center' }} onPress={() => navigation.navigate('Pick topic')}>
                    <FontAwesomeIcon icon={faCircle} size={13} style={{ marginRight: 10 }}></FontAwesomeIcon>
                    <Text style={{ fontSize: 18 }}>Pick a topic </Text>
                </TouchableOpacity>
                <View style={{ borderWidth: 1, marginHorizontal: 15, marginVertical: 10, borderColor: 'grey' }} ></View>
                <TouchableOpacity style={{ flexDirection: 'row', marginLeft: 30, alignItems: 'center' }} onPress={() => navigation.navigate('Favorite articles')}>
                    <FontAwesomeIcon icon={faCircle} size={13} style={{ marginRight: 10 }}></FontAwesomeIcon>
                    <Text style={{ fontSize: 18 }}>Favorite articles </Text>
                </TouchableOpacity>
            </AccordionItem>
            <View style={styles.accordContainer}>
                <TouchableOpacity style={styles.accordHeader} onPress={() => navigation.navigate('Profile')}>
            ...
            <AccordionItem title="About us" icon={faUsers}>
                <TouchableOpacity style={{ flexDirection: 'row', marginLeft: 30, alignItems: 'center' }} onPress={() => navigation.navigate('App history')}>
                    <FontAwesomeIcon icon={faCircle} size={13} style={{ marginRight: 10 }}></FontAwesomeIcon>
                    <Text style={{ fontSize: 18 }}>History</Text>
                </TouchableOpacity>
                <View style={{ borderWidth: 1, marginHorizontal: 15, marginVertical: 10, borderColor: 'grey' }}></View>
                <TouchableOpacity style={{ flexDirection: 'row', marginLeft: 30, alignItems: 'center' }} onPress={() => navigation.navigate('Contact information')}>
                    <FontAwesomeIcon icon={faCircle} size={13} style={{ marginRight: 10 }}></FontAwesomeIcon>
...
function SideMenu() {
    return (
        <Drawer.Navigator
            ...
            <Drawer.Screen name="Daily overview" component={DailyOverview}></Drawer.Screen>
            <Drawer.Screen name="Pick subject" component={PickSubject}></Drawer.Screen>
