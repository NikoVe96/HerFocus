...
export const BottomNavigation = () => {
    ...
    return (
        <View style={{ flexDirection: 'row', height: 60, backgroundColor: colors.light }}>
            <TouchableOpacity style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }} onPress={() => navigation.navigate('Front page')}>
                <FontAwesomeIcon icon={faHouse} size={25} color={colors.primary} />
            ...
            <TouchableOpacity style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }} onPress={() => navigation.navigate('Add task')}>
                <FontAwesomeIcon icon={faCirclePlus} size={25} color={colors.primary} />
                <Text style={{ color: colors.primary, fontWeight: 'bold' }}> New task </Text>
            </TouchableOpacity>
            <TouchableOpacity style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }} onPress={() => navigation.navigate('Daily overview')}>
                <FontAwesomeIcon icon={faSpinner} size={25} color={colors.primary} />
                <Text style={{ color: colors.primary, fontWeight: 'bold' }}> Daily tasks </Text>
            </TouchableOpacity>
            <TouchableOpacity style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }} onPress={() => navigation.navigate('Calendar')}>
                <FontAwesomeIcon icon={faCalendar} size={25} color={colors.primary} />
