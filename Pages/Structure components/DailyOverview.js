                    ...
                    <View style={{
                        ...
                        {remainingTasksArray.length < 1 ? (
                            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                                <Text style={{ fontSize: 20 }}>Du har ingen to-do's på din liste</Text>
                            </View>
                        ) : (
                            <>
                ...
                <Modal
                    ...
                    <View
                        ...
                        <View style={{
                            ...
                            <Text style={{ fontSize: 24, marginLeft: '12%', marginBottom: '10%' }}> Har du ramt væggen?</Text>
                            <TouchableOpacity onPress={() => setWallModalVisible(false)}>
                                <FontAwesomeIcon icon={faCircleXmark} size={25} />
                            </TouchableOpacity>
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', height: '40%' }}>
                            <View style={{ alignItems: 'center', flex: 7, alignSelf: 'flex-start' }}>
                                <Text style={{ fontSize: 20, fontWeight: 'bold', marginVertical: '10%' }}>Udskyd</Text>
                                <Text style={{ textAlign: 'center', fontSize: 16 }}>Hvor meget vil du udskyde din to-do?</Text>
                                <DropDownPicker
                                    open={openTodoTime}
                                    value={todoTime}
                                    items={todoTimes}
                            ...
                            <View style={{
                                borderWidth: 1, borderColor: colors.border, width: '5%', height: '140%', marginHorizontal: '5%', flex: 0.1, backgroundColor: colors.border, borderRadius: 10, alignSelf: 'flex-start', elevation: 5
                            }} />
                            <View style={{ alignItems: 'center', flex: 7, alignSelf: 'flex-start' }}>
                                <Text style={{ fontSize: 20, fontWeight: 'bold', marginVertical: '10%', textAlign: 'center' }}>Fremtidig to-do</Text>
                                <Text style={{ textAlign: 'center', fontSize: 16 }}>Du kan finde listen over dine fremtidige to-do's i din notesbog</Text>
                                <TouchableOpacity style={{
                                    borderWidth: 1,
                                    borderColor: colors.mainButton,
                                    backgroundColor: colors.mainButton,
                                    ...
                                    onPress={() => futureTodo()}>
                                    <Text style={{ textAlign: 'center', fontSize: 16, }}>Flyt til fremtidige to-do's</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    </View>
